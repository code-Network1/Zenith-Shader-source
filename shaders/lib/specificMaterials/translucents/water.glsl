    ...
    // ============================== Step 3: Water Material Features ============================== //
        ...
        if (isEyeInWater != 1) {
            ...
            color.a *= 0.25 + 0.75 * waterFog;
                ...
                // Add enhanced golden tint to water
                color.rgb *= vec3(1.1, 1.05, 0.95); // Subtle golden enhancement
            #endif
            ...
            // Water Foam //
                ...
                if (NdotU > 0.99) {
                    ...
                    // Enhanced golden foam - much more golden and bright
                    vec4 foamColor = vec4(1.0, 0.8, 0.3, 1.0); // Very golden foam
