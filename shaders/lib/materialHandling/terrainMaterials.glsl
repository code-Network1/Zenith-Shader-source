                        ...
                        if (mat < 10016) {
                            if (mat < 10008) {
                                if (mat < 10004) { // No directional shading
                                    ...
                                    // Zenith Shader Enhanced Flowers: Balanced flower detection (NO GRASS)
                                    ...
                                    // Less strict but still exclude grass - Grounded Waving
                                    bool isAnyGrass = (color.g > 0.3 && color.g > color.r * 1.1 && color.g > color.b * 1.1);
                                    bool isBrightColorfulFlower = (totalColor > 1.0 && colorVariance > 0.15); // Relaxed criteria
                                    
                                    if (isBrightColorfulFlower && !isAnyGrass) {
                                        // Include more flowers while still excluding grass
                            ...
                            if (mat < 10024) {
                                if (mat < 10020) { // Non-waving Foliage
                                    ...
                                    // Less strict but still exclude grass - Non-waving
                                    bool isAnyGrass = (color.g > 0.3 && color.g > color.r * 1.1 && color.g > color.b * 1.1);
                                    bool isBrightColorfulFlower = (totalColor > 1.0 && colorVariance > 0.15); // Relaxed criteria
                                    ...
                                    // Zenith Shader Enhanced Flowers: Check if this is a colorful flower
                                    float totalColor = color.r + color.g + color.b;
                                    float colorVariance = max(max(abs(color.r - color.g), abs(color.g - color.b)), abs(color.b - color.r));
                                    
                                    if (totalColor > 1.2 && colorVariance > 0.15) {
                        ...
                        if (mat < 10080) {
                            if (mat < 10072) {
                                ...
                                if (mat < 10076) { // Fire
                                    ...
                                    emission = 2.35;
                                    #ifdef NETHER
                                        emission *= 0.4; // Zenith Shader: Reduce fire emission in Nether
                                    #endif
                                    ...
                                    emission = 1.5;
                                    #ifdef NETHER
                                        emission *= 0.4; // Zenith Shader: Reduce soul fire emission in Nether
                                    #endif
                        ...
                        if (mat < 10400) {
                            ...
                            if (mat < 10408) {
                                ...
                                if (mat < 10412) { // Basalt+
                                    ...
                                    #ifdef NETHER
                                        emission *= 0.3; // Zenith Shader: Significantly reduce glowstone emission in Nether
                                    #endif
                            ...
                            if (mat < 10504) {
                                if (mat < 10500) { // Torch
                                    ...
                                    if (color.r > 0.95) {
                                        ...
                                        #endif
                                        #ifdef NETHER
                                            emission *= 0.4; // Zenith Shader: Reduce torch emission in Nether
                                        #endif
                                        color.r *= 1.4;
                                        color.b *= 0.5;
                                    } 
                                    ...
                                    if (dotColor > 2.0) {
                                        emission = 3.3;
                                        #ifdef END
                                            // Zenith Shader: Enhanced End Rod with magical pulsing
                        ...
                        if (mat < 10560) {
                            ...
                            if (mat < 10568) {
                                if (mat < 10564) { // Lantern
                                    ...
                                    #ifdef NETHER
                                        emission *= 0.4; // Zenith Shader: Reduce lantern emission in Nether
                                    #endif
...
// Zenith Shader: Global emission reduction system for Nether
#ifdef NETHER
    if (emission > 0.1) {
